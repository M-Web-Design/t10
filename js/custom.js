...
$(function () {
  ...
  // --------------------------------------------- //
  $("#countdown").countdown({
    until: $.countdown.UTCDate(+10, 2025, 4, 2),
    format: "D",
  });
  // --------------------------------------------- //
  // KBW-Countdown End
...
// --------------------------------------------- //
// hover video replace start
// --------------------------------------------- //

document.addEventListener("DOMContentLoaded", function () {
  const video = document.querySelector(".image__light");
  ...
  document
    ...
    .addEventListener("mouseleave", function () {
      video.pause();
      video.currentTime = 0; // 滑鼠離開後重置影片
    });
});

// --------------------------------------------- //
// hover video replace End
// --------------------------------------------- //
